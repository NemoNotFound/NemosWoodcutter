...
import static com.nemonotfound.nemos.woodcutter.recipe.WoodcutterRecipeSerializer.WOODCUTTING;
...
public class ModRecipeSerializerFabric {
    ...
    private static <S extends RecipeSerializer<T>, T extends Recipe<?>> Supplier<S> register(String path, S serializer) {
        S registeredSerializer = Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Identifier.fromNamespaceAndPath(MOD_ID, path), serializer);
