...
public class ModRecipeBookCategoryFabric {
    ...
    private static Supplier<RecipeBookCategory> register(String path) {
        RecipeBookCategory recipeBookCategory = Registry.register(BuiltInRegistries.RECIPE_BOOK_CATEGORY, Identifier.fromNamespaceAndPath(MOD_ID, path), new RecipeBookCategory());
